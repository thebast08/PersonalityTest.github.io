questions =  [
    ...
    {"id": 46, "question": "I would always support my country wether it was right or wrong.", "effects": {"auth": 1}}
    {"id": 47, "question": "No one chooses their country of birth so it's foolish to be proud of it", "effects": {"auth": -1}}
    {"id": 48, "question": "Controlling inflation is more important than controlling unemployment", "effects": {"right": -1}} 
    {"id": 49, "question": "It’s a sad reflection on our society that something as basic as drinking water is now a bottled, branded consumer product.", "effects": {"right": 0}}
    {"id": 50, "question": "The rich are too highly taxed", "effects": {"right": -1}}
    {"id": 51, "question": "Abortion, when the woman's life isn't threatened, should be illegal", "effects": {"prog": -1}}
];
